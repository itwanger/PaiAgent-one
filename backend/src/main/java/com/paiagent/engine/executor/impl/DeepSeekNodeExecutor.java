...
@Slf4j
@Component
public class DeepSeekNodeExecutor implements NodeExecutor {
    ...
    public Map<String, Object> execute(WorkflowNode node, Map<String, Object> input) throws Exception {
        ...
        log.info("DeepSeek 节点配置 - API: {}, Model: {}, Temperature: {}", apiUrl, model, temperature);
        log.info("DeepSeek 输入参数配置: {}", inputParams);
        log.info("DeepSeek 输入数据: {}", input);
